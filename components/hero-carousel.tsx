...
const slides = [
  {
    ...
    mobileImage: "/images/mobile-hero-bg.png",
    features: [
  ...
  },
  {
    ...
    mobileImage: "/images/tattoo-background.webp",
    features: [
  ...
  },
  {
    ...
    mobileImage: "/images/tattoo-process-bg.jpg",
    features: [
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            >
              ...
              `}</style>
              <div className="absolute inset-0 bg-gradient-to-br from-black/70 via-gray-900/80 to-black/80 md:bg-gradient-to-br md:from-purple-900/50 md:via-black/70 md:to-green-900/50" />
            </div>
