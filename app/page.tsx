            ...
            <div className="text-center md:text-left relative z-20 w-full">
              ...
              */}
               ...
               */}
                ...
                <h2 className="text-5xl font-bold tracking-widest font-mbf-royal text-[#3EB489] bg-gradient-to-r from-white via-green-400 to-purple-300 bg-clip-text drop-shadow-[0_0_15px_rgba(62,180,137,0.9)] animate-pulse">
