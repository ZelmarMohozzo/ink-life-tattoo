              ...
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    strokeWidth={2}
                    d={isMobileMenuOpen ? "M6 18L18 6M6 6l12 12m5-5H6" : "M4 6h16M4 12h16M4 18h16"}
                  />
                </svg>
              </button>
            </div>
            ...
            {slides.map((slide, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Estilos de tatuaje para el tercer slide */}
                  {currentSlide === 2 && (
                    <div className="mb-6">
                      <p className="text-lg text-gray-300 mb-4 text-center">Nuestros estilos especializados:</p>
                      <div className="flex flex-wrap justify-center gap-3">
                        <span className="px-2 py-1 md:px-4 md:py-2 rounded-full bg-gradient-to-r from-gray-800 to-black text-white font-semibold text-xs md:text-sm border border-gray-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-gray-500/50">
                          Blackwork
                        </span>
                        <span className="px-2 py-1 md:px-4 md:py-2 rounded-full bg-gradient-to-r from-amber-600 to-orange-700 text-white font-semibold text-xs md:text-sm border border-amber-500 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-amber-500/50">
                          Realismo
                        </span>
                        <span className="px-2 py-1 md:px-4 md:py-2 rounded-full bg-gradient-to-r from-blue-600 to-purple-700 text-white font-semibold text-xs md:text-sm border border-blue-500 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-blue-500/50">
                          Neotradicional
                        </span>
                        <span className="px-2 py-1 md:px-4 md:py-2 rounded-full bg-gradient-to-r from-red-700 to-red-900 text-white font-semibold text-xs md:text-sm border border-red-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-red-500/50">
                          Tribales
                        </span>
                      </div>
                    </div>
                  ...
                  {currentSlide === 2 && (
                    <div className="flex flex-row gap-2 sm:gap-4 mt-4">
                      <Button
                        ...
                        className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold px-3 py-2 text-sm sm:px-6 sm:py-3 sm:text-base md:px-8 md:py-4 md:text-lg rounded-full shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-purple-500/50 flex-1 sm:w-auto"
                      >
                        VER PRECIOS
                      </Button>
                      <Button
                        onClick={() => scrollToSection("galeria")}
                        className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold px-3 py-2 text-sm sm:px-6 sm:py-3 sm:text-base md:px-8 md:py-4 md:text-lg rounded-full shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-green-500/50 flex-1 sm:w-auto"
                      >
                        GALERÍA
                        <svg className="w-5 h-5 ml-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
