                  ...
                  {currentSlide === 2 && (
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap justify-center gap-3">
                        <span className="px-4 py-2 rounded-full bg-gradient-to-r from-gray-800 to-black text-white font-semibold text-sm border border-gray-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-gray-500/50">
                          Blackwork
                        </span>
                        <span className="px-4 py-2 rounded-full bg-gradient-to-r from-amber-600 to-orange-700 text-white font-semibold text-sm border border-amber-500 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-amber-500/50">
                          Realismo
                        </span>
                        <span className="px-4 py-2 rounded-full bg-gradient-to-r from-blue-600 to-purple-700 text-white font-semibold text-sm border border-blue-500 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-blue-500/50">
                          Neotradicional
                        </span>
                        <span className="px-4 py-2 rounded-full bg-gradient-to-r from-red-700 to-red-900 text-white font-semibold text-sm border border-red-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-red-500/50">
                          Tribales
                        </span>
                      </div>
                    </div>
